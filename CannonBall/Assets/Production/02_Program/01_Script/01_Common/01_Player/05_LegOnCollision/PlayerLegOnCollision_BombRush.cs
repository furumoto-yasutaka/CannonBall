/*******************************************************************************
*
*	タイトル：	プレイヤーが蹴ったら爆弾も蹴るスクリプト
*	ファイル：	PlayerLegOnCollision_BombRush.cs
*	作成者：	青木 大夢
*	制作日：    2023/09/19
*
*******************************************************************************/
...
public class PlayerLegOnCollision_BombRush : PlayerLegOnCollision
{
    protected override void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            OnTriggerEnter_Bomb(other);
        }
    }

    private void OnTriggerEnter_Bomb(Collider2D other)
    {
        ...
        if (sum >= 0.1f)
        {
            ...
            // ボムを飛ばす
            other.transform.root.GetComponent<BombImpact>().Impact(
